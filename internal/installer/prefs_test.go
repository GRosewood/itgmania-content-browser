...
func TestMergeHosts(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			want:    "*.groovestats.com,*.itgmania.com,stepmaniaonline.net,*.stepmaniaonline.net",
			changed: true,
		},
		{
			name:    "already present is a no-op",
			in:      "*.groovestats.com,stepmaniaonline.net,*.stepmaniaonline.net",
			want:    "*.groovestats.com,stepmaniaonline.net,*.stepmaniaonline.net",
			changed: false,
		},
		{
			name:    "case-insensitive match is a no-op",
			in:      "StepManiaOnline.NET,*.StepManiaOnline.NET",
			want:    "StepManiaOnline.NET,*.StepManiaOnline.NET",
			changed: false,
		},
		{
